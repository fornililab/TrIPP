...
class Visualization: 
    ...
    correlation_file: str, default=None
        ...
        corefficient between a given property (PC1 projection in the tutorial) and the pKa value 
    ...
    start: int, default=0
        ...
        with simulation times from start to end. Not applicable when correlation values are visualised.
    end: int, default=-1
