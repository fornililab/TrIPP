...
class Visualization: 
    ...
    start: int, default=0
    The start time (in the pKa csv file) you would like to calculate mean or 
    difference_to_model values with. Not applicable to correlation.
    
    end: int, default=-1
    The end time (in the pKa csv file) you would like to calculate mean or 
    difference_to_model values with. Not applicable to correlation.
    """
